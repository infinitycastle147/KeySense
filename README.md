...
2. **Diagnose** — a deterministic statistics engine finds real weaknesses (per-bigram
   latency, error taxonomy, finger attribution, fatigue curves), then Claude narrates them
...
Pre-implementation. Architecture, schema, and design language are defined; the typing
engine is next. See `docs/ARCHITECTURE.md` §9 for the phase plan.
